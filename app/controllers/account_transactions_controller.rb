class AccountTransactionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @account_transaction.save
        ...
        format.json { render action: 'show', status: :created, location: @account_transaction }
      else
  ...
  private
    ...
    def account_transaction_params
      params.require(:account_transaction).permit(:account_id, :tran_date, :description, :amount, :sign)
    end
end
